...
class Thermal():
    ...
    def fit_sine(self):
        popt, pcov = curve_fit(sine, self.get_xarray(), self.get_yarray(), [10, 2*np.pi/self.__period, np.pi, 50])
    ...
    def initialization(self, file_name, period, signal_amplitude):
    ...
    def calculate_diffusivities(self, mode = 0, out = False):
        self.plot_mode(mode)
        self.fit_sine()
        ...
        if out == True:
            print("Calculated values of diffusivities are:\nTransmission Factor = %s\nPhase Lag           = %s\n" % (self.get_diffusivity_tf(), self.get_diffusivity_pl()))
        pass
...
'''Task 2.3 a)'''
fourA = Thermal()
fourA.initialization("thermal_4min_a.txt", 240, 50)
...
'''Task 2.4'''
oneA = Thermal()
oneA.initialization("thermal_1min_a.txt", 60, 50)

oneB = Thermal()
oneB.initialization("thermal_1min_b.txt", 60, 50)

twoA = Thermal()
twoA.initialization("thermal_2min_a.txt", 120, 50)

twoB = Thermal()
twoB.initialization("thermal_2min_b.txt", 120, 50)

six = Thermal()
six.initialization("thermal_6min.txt", 360, 50)

eight = Thermal()
eight.initialization("thermal_8min.txt", 480, 50)

sixteen = Thermal()
sixteen.initialization("thermal_16min.txt", 960, 50)
