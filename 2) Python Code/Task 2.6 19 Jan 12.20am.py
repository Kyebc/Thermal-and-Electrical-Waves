...
class Thermal():
    ...
    def plot_mode(self, n = 0, plotmode = True):
        ...
        if plotmode == True:            
            ...
            plt.plot(x, y2, color = "green", label = "Sine fit", linestyle = "dashed")
            plt.grid()
            plt.legend(loc = "upper right")
            plt.xlabel("Time/seconds")
            plt.ylabel("Amplitude [a.u.]")
    ...
    # def return_reduced_amplitude_phase(self, n = 0):
    #     x1 =self.get_xarray()
    #     y2 = []
...
'''Task 2.4'''
oneA = Thermal()
oneA.initialization("thermal_1min_a.txt", 60, 50, plot = True)
# strong uniform transient

oneB = Thermal()
oneB.initialization("thermal_1min_b.txt", 60, 50, plot = True)
# smaller waveform

twoA = Thermal()
twoA.initialization("thermal_2min_a.txt", 120, 50, plot = True)
# good data

twoB = Thermal()
twoB.initialization("thermal_2min_b.txt", 120, 50, plot = True)
# strong transient

six = Thermal()
six.initialization("thermal_6min.txt", 360, 50, plot = True)
# triangular waveform

eight = Thermal()
eight.initialization("thermal_8min.txt", 480, 50, plot = True)
# slightly wavelike waveform

sixteen = Thermal()
sixteen.initialization("thermal_16min.txt", 960, 50, plot = True)
# wavelike waveform

#%%
'''Task 2.5 a)'''
oneA.calculate_diffusivities(1, out = True, plotmode = True)
# oneB.calculate_diffusivities(1, out = True, plotmode = True)
eight.calculate_diffusivities(1, out = True, plotmode = True)

'''Task 2.5 b)'''
twoA.calculate_diffusivities(1, out = True)
# twoB.calculate_diffusivities(1, out = True)
six.calculate_diffusivities(1, out = True)
sixteen.calculate_diffusivities(1, out = True)
